...
RESP_ACCESS_DENIED = 414
RESP_INVALID_TRANSACTION_MODE = 415
...
code2Exception = {
    ...
    RESP_INVALID_TRANSACTION_MODE: InvalidTransactionMode,
    RESP_ACCESS_DENIED: PluginAccessDenied,
...
exception2Code = (
    ...
    (PluginAccessDenied, RESP_ACCESS_DENIED),
